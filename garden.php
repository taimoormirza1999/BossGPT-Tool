...
<body class="dark-mode">
    <div class="garden-container">
        <!-- Add loading overlay -->
        <div id="loadingOverlay" class="position-fixed top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center" style="background: linear-gradient(135deg, #6a1b9a, #4527a0); z-index: 9999;">
            <div class="text-center mb-4">
                <img src="assets/images/garden/seed.png" alt="Garden Seed" style="width: 80px; height: 80px;" class="mb-3 animate__animated animate__pulse animate__infinite">
        ...
        <div class="garden-overlay">
            ...
            <div class="garden-stats">
                ...
                <p>Completed Tasks (Lush Trees): <span id="completedTasks"><?= count(array_filter($plants, function($p) { return $p['stage'] == 'lush_tree'; })) ?></span></p>
                <p>Growing Plants: <span id="growingPlants"><?= count(array_filter($plants, function($p) { return $p['stage'] == 'growing'; })) ?></span></p>
                <p>Seeds Planted: <span id="seedsPlanted"><?= count(array_filter($plants, function($p) { return $p['stage'] == 'seed'; })) ?></span></p>
            </div>
            ...
            <?php if (count($plants) > 0) : ?>
                <div class="achievements mt-4">
                    ...
                    <?php if (count(array_filter($plants, function($p) { return $p['stage'] == 'lush_tree'; })) >= 3) : ?>
                        <div class="achievement-badge">🌳 Forest Creator</div>
                    <?php endif; ?>
                    
                    <?php if (count(array_filter($plants, function($p) { return $p['stage'] == 'lush_tree' && $p['size'] == 'large'; })) >= 1) : ?>
