    ...
    <div class="container-fluid sides-padding" style="overflow: visible;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex align-items-center nav-btn-container">
                ...
                <button onclick="openLink('<?php echo $_ENV['BASE_URL'] ?>/garden.php')"
                ...
                <button type="submit" class="btn btn-outline-light btn-logout" data-bs-toggle="tooltip"
                    data-bs-placement="bottom" title="Invite User"><?php echo getAddUserIcon(); ?></button>
                <button type="submit" class="btn btn-outline-light btn-logout " data-bs-toggle="tooltip"
                    data-bs-placement="bottom" title="Project Activity"><?php echo getClockIcon(); ?></button>
                    ...
                    <image src="<?php echo $_SESSION['avatar_image'] ?? $images['default-user-image'] ?>"
                        style="width: 44px; height: 44px; border-radius: 50%; border: 2px solid rgba(248, 249, 250, 0.5);"
                        class=" btn-logout" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Profile"
                        onclick="openLink('<?php echo $_ENV['BASE_URL'] ?>/profile')" />
                    <!-- Logout Form -->
